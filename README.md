<!-- mcp-name: CSOAI-ORG/ecommerce-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/ecommerce-ai-mcp.html)
...
```json
{
  "mcpServers": {
    "ecommerce-ai-mcp": {
      "command": "uvx",
      "args": ["ecommerce-ai-mcp"]
    }
  }
}
```

Or: `pip install ecommerce-ai-mcp` then run the `ecommerce-ai-mcp` command (stdio transport).

## Examples

Once configured, ask your assistant, for example:
- "Use `write_product_description` to …"
- "Use `optimize_pricing` to …"
- "Use `summarize_reviews` to …"
